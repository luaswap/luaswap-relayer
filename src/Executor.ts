import { Pair, Percent, Token, TokenAmount, Trade } from "@luaswap/sdk";
import { address } from "./contracts/deployments/mainnet/Settlement.json";
...
const deductFee = (amount: ethers.BigNumber) => {
    return amount.sub(amount.mul(4).div(1000)); // Fee: 0.4%
};
